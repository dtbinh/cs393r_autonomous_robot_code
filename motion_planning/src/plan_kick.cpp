...
//      }
    ...
    planMove(-0.03, -foot_separation, 0.015, -0, 0.01, 0.0, 0.3333333);
    std::cerr << "Planning kick" << std::endl;
    planMove(0.05, -foot_separation, 0.03, -0, 0.01, 0.0, 0.4);

    std::cerr << "Planning lunge" << std::endl;
    planMove(0.0, -foot_separation, -0.0, 0.0, 0.01, -0.03, 0.3333333);
    std::cerr << "Planning delay" << std::endl;
    planMove(0.0, -foot_separation, -0.0, 0.0, 0.01, -0.03, 5.0);
