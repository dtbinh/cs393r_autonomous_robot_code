...
//      }
    ...
    planMove(kick_dist, -foot_separation-landing_splay, 0.0, 0.0, kick_dist/2.0, (-foot_separation-landing_splay)/2.0, 0.6);
    std::cerr << "Planning stay" << std::endl;
    planMove(kick_dist, -foot_separation-landing_splay, 0.0, 0.0, kick_dist/2.0, (-foot_separation-landing_splay)/2.0, 10.0);
